label sch_day0_cr:
    ...
    if sch_true:
        $ sch_chapter(0, u"Последний путь.", sch_part=1)

    elif sch_bound:
        $ sch_chapter(0, u"Правильный выбор.", sch_part=1)

    else:
        $ sch_chapter(0, u"Сквозь время и пространство.", sch_part=1)

    $ sch_chapter(0, new_day=True)
    ...
    if not true_prologue:
        ...
        call sch_day0_prehistory_part_2 # Часть 2
