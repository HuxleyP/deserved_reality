label dr_day1_intro:
    ...
    "А вот одно из недавних воспоминаний - я пишу о том, что меня посетила тульпа и я на всякий случай пишу завещание. Обычными чёрно-синими, искрящимися через прозрачный корпус авторучки, чернилами на бумаге, которой в наши дни пользуются разве что параноики да художники, не осознавшие ценность дешевейшего полимера, стилус для которого почти не стирается и заменяет всевозможные фломастеры и карандаши всех видов."
...
>>>>>>> 533d3b0a45a88a23d0018370a6f09eb07a990ba4
    return
