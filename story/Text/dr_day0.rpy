label dr_day0_prehistory_part_1:
    ...
    th "Неужели выкинут? Хотя, учитывая то, какой фигнёй я маялся последний месяц, я даже не удивлён."
    ...
    th "Похоже, намекнул на то, что мне пора валить из института подальше."
    ...
    ivan "Мне бы не хотелось, чтобы какой-нибудь программист хакнул мои глаза. Это же живой орган тела, чёрт возьми, а с кибербезопасностью шутки плохи."
    ...
    th "Так ты нашла меня. Ты следила за мной все это время. Я знал это…"
    with fade
    ...
    "Схватив тяжелую вазу с латанией, я вбежал в комнату и подошел к окну, тяжело дыша и посмотрел вниз."
    "Огни ночного города где-то в ста метрах от меня привели меня в чувство. Мои мысли выстроились в логическую взаимосвязь. Я взял себя в руки и закрыл глаза."
    ...
    th "Как же я просчитался. Совсем забыл, что я нахожусь под постоянным наблюдением."
    ...
    menu:
        ...
        "Сопротивляться":
            ...
            th "Ну уж нет. Я не позволю вам так поступить со мной. Спасибо за оказанную медицинскую услугу, могу я расплатиться наличными? Вы принимаете карту? А может лучше я отработаю свой долг своей памятью?"
            ...
            menu:
                ...
                "Разбить окно":
                    ...
                    uv "Прыгай."
                    "Лаконично произнёс мой голос, и я не смел противиться его приказу."
