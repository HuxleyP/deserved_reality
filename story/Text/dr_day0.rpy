label sch_day0_prehistory_part_1:
    ...
    scene bg panorama_room with dissolve
        ...
        "Сопротивляться":
            ...
            menu:
                ...
                "Разбить окно":
                    ...
                    "Бесцветно ответил я."
                    ivan "Встретимся в Лимбе."
                    "Я резко развернулся, сжал пальцами стеклянную вазу и, разбежавшись, кинул ее в панорамное окно, которое несколько часов назад представляло собой огромный, розовый аквариум с легкими стенками и стеклянными башнями по ту сторону."
