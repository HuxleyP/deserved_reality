label dr_day0_prehistory_part_1:
    ...
    iv "Ну… {w=0.5}началось. Каждый день повторяется с самого начала, копирует предыдущий и делится надвое, как клетки в живом организме. Мои сны – нечёткая зашакаленная гифка. Мои мысли – на вечном реверсе. И нет выхода из Лабиринта Фавна."
    iv "Забавно."
    ...
    iv "Какая же это пошлая и избитая трагедия. Французский флер и мишура. Говорить и размышлять по-гамлетовски в XXI веке – все равно, что проходить капчу за деньги. Вроде прикольно, но бессмысленно."
    ...
    iv "Как же я просчитался. Совсем забыл, что я нахожусь под постоянным наблюдением."
    ...
    menu:
        ...
        "Сопротивляться":
            ...
            iv "Да, чёрт возьми. Разве я могу сказать сейчас что-то другое? Просто помоги мне. Прошу."
