label sch_day2_start:
    ...
    iv "Если бы мои зубы имели разум, они бы резко начали дергать нервную систему, чтобы я потерял сознание от шока и не обливал их жидким азотом."
    ...
    menu:
        ...
        "Прогулка придаст бодрости!":
            ...
            "Спросонья мне приходилось объяснять себе даже такие простые вещи, как истоптанность тропинки, а какой там был лес я даже и не спрашивал."
            ...
            if 'un' in list_sch_ch_known:
                ...
                if 'un' in list_sch_day2_walk:
                    ...
                    "Вчера я лишь видел я её, но так толком и не поговорил."
                    "Какая-то она замкнутая."
                ...
                if 'un' in list_sch_day2_walk:
                    ...
                    if pt_un >=7:
                        ...
                        un "Хорошо."
                        "Лена вложила свою руку в мою и мы вместе пошли по лагерю."
                        return
                    else:
                ...
                ivan "Тоже не спится?"
                un "..."
                ivan "Извини за глупый мои манеры. Я Иван."
                ...
                # мимолётное смущение обратно в норм
                un "С-спасибо."
                "Девочка опять выдавила из себя слово. Похоже, она ни с кем не здоровается и никого не благодарит."
            ...
            un "Шесть где-то."
            iv "Вот это опыт! За шесть лет только бездарность не научится рисовать, а, зная Лену настолько, насколько я могу знать её сейчас, она бы не стала говорить про себя то, в чём она не уверена."
