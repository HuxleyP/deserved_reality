label sch_day0_prehistory_part_1:
    ...
    iv "чёртвозьми, какая же это пошлая и избитая трагедия. Французский флер и мишура. Говорить и размышлять по-гамлетовски в XXI веке – все равно, что проходить капчу за деньги. Вроде прикольно, но бессмысленно."
    ...
    chat "Я не на шоу Линча, чёртвозьми. Я тоже человек. {w}Я жить хочу."
    ...
    ivan "Мне бы не хотелось, чтобы какой-нибудь программист хакнул мои глаза. Это же живой орган тела, чёртвозьми, а с кибербезопасностью шутки плохи."
    ...
    "чёртвозьми, Старина Корж. Ты как всегда оказался прав."
    ...
    $ set_mode_nvl()
    "А потом пошли бесконечные люблю, ненавижу, прости, понимаешь, клянусь. Это можно было продолжать вечно. Ругаться – это так просто, чёртвозьми."
    "Ломать – не строить."
    ivan "Прости, прощай."
    nvl clear
    ...
    with fade
    uv "Ты помнишь…"
    "Конечно помню, возьми. Все до конца."
    # фон?
    ...
    iv "чёртвозьми, как же я просчитался. Совсем забыл, что я нахожусь под постоянным наблюдением."
    menu:
        "Сдаться":
        ...
        "Сопротивляться":
            ...
            iv "Да, чёртвозьми. Разве я могу сказать сейчас что-то другое? Просто помоги мне. Прошу."
