...
label sch_prologue_normal:
    ...
    ivan "Мне 23 года. Хвастаться нечем - я идиот."

    scene semen_room_sunset
    $ renpy.pause(1, hard=True)

    iv "Вот и всё. Теперь я сам по себе."
    iv "Сам зарабатываю, сам плачу за квартиру."
    iv "Фриланс."
    iv "И снова творчество. Правда времени нет почти."
    iv "Потом эта неприятная ситуация с последним человеком, который был мне дорог и покинул меня."
    iv "А что сейчас? Хочется лишь сбежать от мира в мир вакуумных наушников и музыки на репите и больше не возвращаться."
