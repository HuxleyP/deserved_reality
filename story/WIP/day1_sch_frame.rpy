...
label sch_day1_dinner:
    ...
    ivan "Класс. Хороших мест нет, свободных, видимо, тоже."
    iv "Похоже, что мне ещё повезло - младшие отряды так вообще до сих пор на улице стоят в очереди."
    ...
    menu:
            ...
            # Садится с Ульяной, она по классике жанра пиздит котлетос
                ...
                menu:
                    ...
                    "Сбежит!":
                        ...
                        # Чёто тело другое и Ульянка не особо догоняется, в поле зрения появляется отличный бросаемый элемент - камень
                        # Ну что, играть в блинчики с живыми людьми будем?
                        menu:
                            "Кинуть камень":
                                # Удар в яблочко по задней стороне коленки, Уля наворачивается на красивую землю
                            "Не бросать":
        ...
        "Сесть с Алисой" if 'dv' in list_sch_ch_known and pt_wi >=30:
            $ pt_dv +=1
